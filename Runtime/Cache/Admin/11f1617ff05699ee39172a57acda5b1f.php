        ...
        <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
            <ul class="cl">
                ...
                <li class="dropDown dropDown_hover">
                    <a href="#" class="dropDown_A"><?php echo ($user["username"]); ?> <i class="Hui-iconfont">&#xe6d5;</i></a>
                    <ul class="dropDown-menu menu radius box-shadow">
                        <li><a href="javascript:;" onClick="myselfinfo()">个人信息</a></li>
                        <li><a href="#">切换账户</a></li>
                        <li><a href="<?php echo U('home/logout');?>">退出</a></li>
                    </ul>
                </li>
...
<aside class="Hui-aside">
    ...
    <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><dl id="menu-article">
            <dt>
                <i class="Hui-iconfont"><?php echo ($menu["icon"]); ?></i>
                <?php echo ($menu["name"]); ?>
                <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
            </dt>
            <dd>
                <ul>
                    <?php if(is_array($menu['menu'])): $i = 0; $__LIST__ = $menu['menu'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                            <a data-href="<?php echo U($vo['url']);?>" data-title="<?php echo ($vo["name"]); ?>" href="javascript:void(0)">
                                <?php echo ($vo["name"]); ?>
                            </a>
...
<section class="Hui-article-box">
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo U('home/welcome');?>"></iframe>
		</div>
	</div>
</section>
