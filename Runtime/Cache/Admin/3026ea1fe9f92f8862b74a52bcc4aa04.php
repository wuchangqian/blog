...
<article class="page-container">
    <form action="/admin.php/posts/add.html" method="post" class="form form-horizontal" id="form-member-add">
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-6">
                <select name="cate" class="input-text">
                    ...
                    <?php if(is_array($dict['cates'])): $i = 0; $__LIST__ = $dict['cates'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?><option value="<?php echo ($cate["id"]); ?>"><?php echo ($cate["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-6">
                <?php if(is_array($dict['tags'])): $i = 0; $__LIST__ = $dict['tags'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$tag): $mod = ($i % 2 );++$i;?><div style="float: left; margin-right: 15px;">
                        <input type="checkbox" id="<?php echo ($tag["id"]); ?>" name="tags[]" value="<?php echo ($tag["id"]); ?>">
        ...
        $('#file_up').on('change', function () {
            ...
            $.ajax({
                ...
                success: function (res) {
                    if(res.code == 0){
                        var html = '<img src="'+ res.data.path+'" style="width: 250px;" />';
                        $('.img-pre').html(html);
