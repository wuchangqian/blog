...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    ...
    <form class="form form-horizontal" action="/admin.php/index/index.html" method="post">
      <div class="row cl">
      ...
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          ...
          <img id="verityImg" src="/tool.php/valid/code.html"> <a id="kanbuq" href="javascript:;">看不清，换一张</a> </div>
      </div>
      <div class="row cl">
        <div class="formControls col-xs-8 col-xs-offset-3">
          <label for="online">
...
<script>
    $(document).ready(function(){
        ...
        function refresh() {
            $('#verityImg').attr('src' , "/tool.php/valid/code.html");
        }
        ...
        $('#login').click(function () {
            ...
            if($('#online').is(':checked')) {
                var data = {'username':username , 'password':password , 'verifyCode':verifyCode , 'online':1};
            }else{
