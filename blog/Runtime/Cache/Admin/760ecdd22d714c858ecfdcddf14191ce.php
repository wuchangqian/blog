    ...
    <table class="table table-border table-bordered table-bg">
        ...
        <tbody>
            <tr>
              ...
              <td>
                  <input type="text" id="name" class="input-text"  tabindex="1" value="<?php echo ($role["name"]); ?>">
              </td>
            </tr>
            <tr>
                <th class="text-r">角色描述：</th>
                <td>
                    <textarea id="description" class="input-text" style="width: 100%;height: 80px;"><?php echo ($role["description"]); ?></textarea>
                </td>
            </tr>
            <tr>
              <th></th>
...
<script>
    ...
    $(document).ready(function(){
        $('#save').click(function () {
            ...
            $.ajax({
                url: '/Admin/admin/roles_edit/rid/26.html?act=edit',
                type: 'POST',
                data: data,
