...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		...
		<span class="r">共有数据：<strong><?php echo ($powers["total"]); ?></strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<?php if(is_array($powers['list'])): $i = 0; $__LIST__ = $powers['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="text-c">
					...
					<td>
                        <a title="编辑" href="javascript:;" onclick="admin_permission_edit('权限编辑','admin-permission-add.html','1','','310')" class="ml-5" style="text-decoration:none">
                            <i class="Hui-iconfont">&#xe6df;</i>
                        </a>
                    </td>
